...
import React, { useState, useEffect } from 'react';
import { API_URL } from '../config';
import AddProductModal from './AddProductModal'; // ✅ ИМПОРТ НОВОГО КОМПОНЕНТА
...
const ShopManagementPanel = ({ admin }) => {
  ...
  // ✅ НОВЫЕ СОСТОЯНИЯ для создания товара
  const [showAddProductModal, setShowAddProductModal] = useState(false);
  const [categories, setCategories] = useState([]);
  ...
  return (
    <>
                ...
                <div style={{
                  ...
                  <button
                    ...
                    style={{
                      ...
                      justifyContent: 'center',
                      gap: '0.5rem',
                      marginBottom: '0.5rem' // ✅ Добавили отступ снизу
                    }}
                  >
                    📦 Управление товарами
                  </button>
      ...
      {/* ✅ НОВЫЙ КОМПОНЕНТ: Модальное окно добавления товара */}
      <AddProductModal

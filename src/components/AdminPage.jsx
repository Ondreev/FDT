...
import { AdminLogin, OrderCard } from './components.jsx';
import { 
  API_URL, 
  formatNumber, 
...
const AdminDashboard = ({ admin, onLogout }) => {
  ...
  // Правильный расчет трафика (количество заказов за сегодня)
  ...
  // Правильный расчет среднего чека
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        {/* Сообщение от бота в стиле WhatsApp */}
        <div style={{
          display: 'flex',
          gap: '0.75rem',
          marginBottom: '1.5rem',
